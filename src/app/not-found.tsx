...
export default function NotFound() {
  return (
    <div className="min-h-screen flex items-center justify-center bg-qwaam-white outline-none flex-col relative overflow-hidden text-center p-6 w-full" dir="rtl">
